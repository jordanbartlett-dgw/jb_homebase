...
# Note: Phase 1 tool imports disabled pending factory refactor (Task 5)
...
#     schedule_event,
# )
# from jordan_claw.tools.time import current_datetime as get_current_datetime
# from jordan_claw.tools.web_search import search_web

# Phase 1 hardcoded agent creation disabled pending factory refactor (Task 5)
# SYSTEM_PROMPT = """\

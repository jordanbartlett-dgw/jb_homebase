...
prompt: the SQL literal in migration 036 and TRIAGE_PROMPT_TEMPLATE in
...
MIGRATION_PATH = REPO_ROOT / "supabase/migrations/036_invoice_triage_carveout.sql"
...
def _extract_sql_prompt() -> str:
    ...
    assert match, "could not locate prompt_template literal in migration 036 SQL"
